...
public class ServerStopChargingResp implements CmdBase, IPortBasedCmd, ISessionBasedCmd {
	...
	public ServerStopChargingResp() {
		
	}
	
	public ServerStopChargingResp(long chargeId, long sessionId, byte chargePortId, ErrorCode errorCode) {
