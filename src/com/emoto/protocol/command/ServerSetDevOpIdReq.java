...
public class ServerSetDevOpIdReq extends CmdBase {
	...
	public ServerSetDevOpIdReq(long chargerId, String hwUniqueId, long sessionId, long destChargerId, String signature) {
