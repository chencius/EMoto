...
public class ClientConnectSucceedResp extends CmdBase implements IPortBasedCmd {
	...
	public ClientConnectSucceedResp(long chargerId, byte chargerPortId, byte errorCode) {
