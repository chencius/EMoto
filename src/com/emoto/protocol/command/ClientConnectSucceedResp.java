...
public class ClientConnectSucceedResp implements CmdBase, IPortBasedCmd, ISessionBasedCmd {
	...
	public ClientConnectSucceedResp() {
	}
	
	public ClientConnectSucceedResp(long chargeId, long sessionId, byte chargePortId, ErrorCode errorCode) {
