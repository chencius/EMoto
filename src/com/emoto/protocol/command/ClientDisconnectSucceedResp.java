...
public class ClientDisconnectSucceedResp implements CmdBase, IPortBasedCmd, ISessionBasedCmd {
	...
	public ClientDisconnectSucceedResp() {
	}
	
	public ClientDisconnectSucceedResp(long chargeId, long sessionId, byte chargePortId, ErrorCode errorCode) {
